async function instantiate(module, imports = {}) {
  const adaptedImports = {
    env: Object.assign(Object.create(globalThis), imports.env || {}, {
      ...
      sk_exec_command(cmdPtr, cmdLen, outPtr, outMaxLen) {
        // assembly/index/sk_exec_command_ffi(usize, usize, usize, usize) => i32
        cmdPtr = cmdPtr >>> 0;
        cmdLen = cmdLen >>> 0;
        outPtr = outPtr >>> 0;
        outMaxLen = outMaxLen >>> 0;
        return sk_exec_command(cmdPtr, cmdLen, outPtr, outMaxLen);
      },
    }),
  };
  ...
  const adaptedExports = Object.setPrototypeOf({
    ...
    handle_get_logs(requestPtr, requestLen) {
      // assembly/index/handle_get_logs(usize, usize) => ~lib/string/String
      return __liftString(exports.handle_get_logs(requestPtr, requestLen) >>> 0);
    },
  }, exports);
